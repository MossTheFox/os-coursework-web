...
var Module = typeof liuModuleA != 'undefined' ? liuModuleA : {};
...
["_main","__emscripten_thread_init","__emscripten_thread_exit","__emscripten_thread_crashed","__emscripten_tls_init","_pthread_self","executeNotifiedProxyingQueue","establishStackSpace","invokeEntryPoint","PThread","_run_program_communication","_run_EDF","_run_LLF","_fflush","__emscripten_proxy_execute_task_queue","onRuntimeInitialized"].forEach((prop) => {
...
var wasmBinaryFile;
  wasmBinaryFile = 'liu-program-combined.wasm';
...
function wait_for_string() { return Asyncify.handleSleep((wakeup) => { (async () => { let result = await stdinEmu('string'); let lengthBytes = lengthBytesUTF8(result) + 1; var stringOnWasmHeap = _malloc(lengthBytes); stringToUTF8(result, stringOnWasmHeap, lengthBytes); wakeup(stringOnWasmHeap); })(); }); }
  ...
  var PThread = {unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],pthreads:{},init:function() {
        ...
        var pthreadMainJs = locateFile('liu-program-combined.worker.js');
  ...
  function invokeEntryPoint(ptr, arg) {
      ...
      // ABI extension.
      var result = (function(a1) { return dynCall_ii.apply(null, [ptr, a1]); })(arg);
      checkStackCookie();
      if (keepRuntimeAlive()) {
  ...
  var Asyncify = {instrumentWasmImports:function(imports) {
        var ASYNCIFY_IMPORTS = ["env.wait_for_string","env.invoke_*","env.emscripten_sleep","env.emscripten_wget","env.emscripten_wget_data","env.emscripten_idb_load","env.emscripten_idb_store","env.emscripten_idb_delete","env.emscripten_idb_exists","env.emscripten_idb_load_blob","env.emscripten_idb_store_blob","env.SDL_Delay","env.emscripten_scan_registers","env.emscripten_lazy_load_code","env.emscripten_fiber_swap","wasi_snapshot_preview1.fd_sync","env.__wasi_fd_sync","env._emval_await","env._dlopen_js","env.__asyncjs__*"].map((x) => x.split('.')[1]);
...
/** @type {function(...*):?} */
var _run_program_communication = Module["_run_program_communication"] = createExportWrapper("run_program_communication");

/** @type {function(...*):?} */
var _run_EDF = Module["_run_EDF"] = createExportWrapper("run_EDF");

/** @type {function(...*):?} */
var _run_LLF = Module["_run_LLF"] = createExportWrapper("run_LLF");
...
var ___start_em_js = Module['___start_em_js'] = 16684;
var ___stop_em_js = Module['___stop_em_js'] = 16971;
...
run();
  ...
  return liuModuleA.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = liuModuleA;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return liuModuleA; });
else if (typeof exports === 'object')
  exports["liuModuleA"] = liuModuleA;
