...
var Module = typeof pdModule != 'undefined' ? pdModule : {};
...
["_main","__emscripten_thread_init","__emscripten_thread_exit","__emscripten_thread_crashed","__emscripten_tls_init","_pthread_self","executeNotifiedProxyingQueue","establishStackSpace","invokeEntryPoint","PThread","_run","_fflush","__emscripten_proxy_execute_task_queue","onRuntimeInitialized"].forEach((prop) => {
...
var wasmBinaryFile;
  wasmBinaryFile = 'producer_consumber.wasm';
...
var ASM_CONSTS = {
  ...
  var PThread = {unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],pthreads:{},init:function() {
        ...
        var pthreadMainJs = locateFile('producer_consumber.worker.js');
...
run();
  ...
  return pdModule.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = pdModule;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return pdModule; });
else if (typeof exports === 'object')
  exports["pdModule"] = pdModule;
