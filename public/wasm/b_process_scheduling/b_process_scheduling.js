...
var createBProcessSchedulingModule = (() => {
  var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
  if (typeof __filename !== 'undefined') _scriptDir = _scriptDir || __filename;
  return (
function(createBProcessSchedulingModule) {
  createBProcessSchedulingModule = createBProcessSchedulingModule || {};
...
var Module = typeof createBProcessSchedulingModule != 'undefined' ? createBProcessSchedulingModule : {};
...
["_main","__emscripten_thread_init","__emscripten_thread_exit","__emscripten_thread_crashed","__emscripten_tls_init","_pthread_self","executeNotifiedProxyingQueue","establishStackSpace","invokeEntryPoint","PThread","_run_EDF","_run_LLF","_fflush","__emscripten_proxy_execute_task_queue","onRuntimeInitialized"].forEach((prop) => {
...
var wasmBinaryFile;
  wasmBinaryFile = 'b_process_scheduling.wasm';
...
var ASM_CONSTS = {
  ...
  var PThread = {unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],pthreads:{},init:function() {
        ...
        var pthreadMainJs = locateFile('b_process_scheduling.worker.js');
...
run();
  ...
  return createBProcessSchedulingModule.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = createBProcessSchedulingModule;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return createBProcessSchedulingModule; });
else if (typeof exports === 'object')
  exports["createBProcessSchedulingModule"] = createBProcessSchedulingModule;
