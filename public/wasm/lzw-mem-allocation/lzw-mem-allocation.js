...
var lzwMemAllocation = (() => {
  var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
  if (typeof __filename !== 'undefined') _scriptDir = _scriptDir || __filename;
  return (
function(lzwMemAllocation) {
  lzwMemAllocation = lzwMemAllocation || {};
...
var Module = typeof lzwMemAllocation != 'undefined' ? lzwMemAllocation : {};
...
var wasmBinaryFile;
  wasmBinaryFile = 'lzw-mem-allocation.wasm';
...
function wait_for_string() { return Asyncify.handleSleep((wakeup) => { (async () => { let result = await stdinEmu('string'); let lengthBytes = lengthBytesUTF8(result) + 1; var stringOnWasmHeap = _malloc(lengthBytes); stringToUTF8(result, stringOnWasmHeap, lengthBytes); wakeup(stringOnWasmHeap); })(); }); }
  ...
  var Asyncify = {instrumentWasmImports:function(imports) {
        var ASYNCIFY_IMPORTS = ["env.wait_for_number","env.wait_for_string","env.invoke_*","env.emscripten_sleep","env.emscripten_wget","env.emscripten_wget_data","env.emscripten_idb_load","env.emscripten_idb_store","env.emscripten_idb_delete","env.emscripten_idb_exists","env.emscripten_idb_load_blob","env.emscripten_idb_store_blob","env.SDL_Delay","env.emscripten_scan_registers","env.emscripten_lazy_load_code","env.emscripten_fiber_swap","wasi_snapshot_preview1.fd_sync","env.__wasi_fd_sync","env._emval_await","env._dlopen_js","env.__asyncjs__*"].map((x) => x.split('.')[1]);
...
var ___start_em_js = Module['___start_em_js'] = 15492;
var ___stop_em_js = Module['___stop_em_js'] = 15909;
...
run();
  ...
  return lzwMemAllocation.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = lzwMemAllocation;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return lzwMemAllocation; });
else if (typeof exports === 'object')
  exports["lzwMemAllocation"] = lzwMemAllocation;
