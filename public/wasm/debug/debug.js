...
var Module = typeof debugModule != 'undefined' ? debugModule : {};
...
["_main","__emscripten_thread_init","__emscripten_thread_exit","__emscripten_thread_crashed","__emscripten_tls_init","_pthread_self","executeNotifiedProxyingQueue","establishStackSpace","invokeEntryPoint","PThread","_print_something","_input_something","_param_something","_start_endless_thread","_end","_fflush","__emscripten_proxy_execute_task_queue","onRuntimeInitialized"].forEach((prop) => {
...
function wait_for_number() { return Asyncify.handleSleep((wakeup) => { (async () => { let result = await stdinEmu('int'); wakeup(+result); })(); }); }
  ...
  var PThread = {unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],pthreads:{},init:function() {
        ...
        var pthreadMainJs = locateFile('debug.worker.js');
  ...
  var Asyncify = {instrumentWasmImports:function(imports) {
        var ASYNCIFY_IMPORTS = ["env.wait_for_number","env.invoke_*","env.emscripten_sleep","env.emscripten_wget","env.emscripten_wget_data","env.emscripten_idb_load","env.emscripten_idb_store","env.emscripten_idb_delete","env.emscripten_idb_exists","env.emscripten_idb_load_blob","env.emscripten_idb_store_blob","env.SDL_Delay","env.emscripten_scan_registers","env.emscripten_lazy_load_code","env.emscripten_fiber_swap","wasi_snapshot_preview1.fd_sync","env.__wasi_fd_sync","env._emval_await","env._dlopen_js","env.__asyncjs__*"].map((x) => x.split('.')[1]);
...
/** @type {function(...*):?} */
var _print_something = Module["_print_something"] = createExportWrapper("print_something");

/** @type {function(...*):?} */
var _input_something = Module["_input_something"] = createExportWrapper("input_something");

/** @type {function(...*):?} */
var _param_something = Module["_param_something"] = createExportWrapper("param_something");

/** @type {function(...*):?} */
var _start_endless_thread = Module["_start_endless_thread"] = createExportWrapper("start_endless_thread");
...
var ___start_em_js = Module['___start_em_js'] = 16500;
var ___stop_em_js = Module['___stop_em_js'] = 16630;
...
if (typeof exports === 'object' && typeof module === 'object')
  ...
  define([], function() { return debugModule; });
